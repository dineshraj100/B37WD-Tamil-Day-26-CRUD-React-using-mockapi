...
export default function Users() {
  ...
  const getProducts = () => {
    fetch('https://624a7f85852fe6ebf887cb09.mockapi.io/users')
      .then((data) => data.json())
  ...
  const handleDelete = (prop) => {
    fetch('https://624a7f85852fe6ebf887cb09.mockapi.io/users/' + prop, {
      method: 'DELETE',
    })
      .then((data) => data.json())
      .then(() => {
